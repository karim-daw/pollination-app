""" sample code found here https://github.com/pollination/sample-apps/blob/master/compare-daylight-results/app.py """
...
from vtk_configs.vtk_config import daylight_factor_config


st.set_page_config(
    page_title='Compare annual daylight studies', layout='wide',
)
...
column_count = st.sidebar.slider(
    label='Number of columns', min_value=2, max_value=4
)
...
job = job_selector(
    default='https://app.pollination.cloud/projects/karimdaw/annualdaylight-shoebox1/jobs/54e42be6-5f06-41aa-b305-c5d50b31a50f',
